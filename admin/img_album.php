...
$query1= "INSERT INTO `album_details` (`album_id`,`caption`,`image`) VALUES('$album_id','$caption','$thumb_img1')";
$query_exi1= mysql_query($query1) or die(mysql_error());

echo "<script type='text/javascript'> window.location= 'img_album.php?success'; </script>";	
...
<tr> <td height="40" colspan="7"  align="center" class="edit">Image Gallery</td> </tr>
<form name="add1" id="add1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">

<tr>
  <td height="35" align="left" valign="middle" class="form_txtr">Select Album</td>
  <td height="35" align="left" valign="middle"><select name="album_id" id="album_id" class="rounded" style="width:265px; height:30px;">
    <option value=""> Select Album</option>
     <?php
$sql3 = "SELECT * from `album`";
$rs3 = mysql_query($sql3);
while($row3 = mysql_fetch_array($rs3))
{
?>
    <option value="<?php echo $row3['id']; ?>"><?php echo $row3['album_name']; ?></option>
    <?php } ?>
    </select></td>
  <td width="232" rowspan="4" align="center" valign="top"><span class="edit"><img src="" alt="" width='200' height='100' id="test"/></span></td>
</tr>
<tr>
<td width="182" height="35" align="left" valign="middle" class="form_txtr">Caption</td>
<td width="232" height="35" align="left" valign="middle"><input type="text" id="caption" name="caption" value="" /></td>
</tr>
<tr>
  <td height="35" align="left" valign="middle" class="form_txtr">Image:</td>
  <td height="35" align="left" valign="middle"><input onchange="readURL(this);" type="file" name="static_ad1" id="static_ad1" style="width:250px; height:20px;" />(720 * 570)</td>
  </tr>
<tr>
...
?>
   <a href="criteria.php?id=<?php echo $id;?>" class="style1" onclick="return popitup('criteria.php?id=<?php echo $id;?>')" style="color:#000000;">
    <table width="200" border="0" cellspacing="0" cellpadding="0" align="left" style="margin-right:12px; margin-bottom:10px;">
      <tr>
        <td height="155" align="center" valign="bottom" style="background-image:url(images/folder.png);"><img src="chobighar/<?php echo $imagee; ?>" width="191" height="124" style="padding-bottom:5px; border-radius: 5px 5px 0px 0px; "/></td>
      </tr>
      <tr>
        <td height="25" align="center" class="form_txtr"><?php echo $album_name; ?></td>
      </tr>
    </table>
    </a>
    <?php } ?>
