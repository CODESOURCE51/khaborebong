...
$rand= rand(1000, 9999);
$target = "logo/"; 
$target = $target.$rand.basename($_FILES['logo']['name']) ; 
move_uploaded_file($_FILES['logo']['tmp_name'], $target); 
$logo= basename($rand.$_FILES['logo']['name']);

/////////////////////////////////////////////////////

$query= "INSERT INTO `logo_upload` (`category`,`logo`) 
                       VALUES('$category','$logo')";

			$query_exi= mysql_query($query) or die(mysql_error());
		
echo "<script type='text/javascript'> window.location= 'logoupload.php?success'; </script>";
...
<tr> <td height="40" colspan="4"  align="center" class="edit">Header Ads Upload (Each category should have 5 picture for proper functioning size 670 X 120px)</td> </tr>
...
<tr> 
  <td height="20" align="left" class="form_txtr">Ads</td>  <td width="7" height="35" align="center" valign="middle"> : </td>
  <td width="250" height="35" align="left" valign="middle" class="error">
    <input onchange="readURL(this);" type="file" name="logo" id="slider_image" style="width:250px; height:20px;" /></td>
  <td width="217" rowspan="2" align="left" valign="middle"><img alt="" id="test" src="" /></td>
</tr>
...
<tr>
  ...
  <td height="35" colspan="2" align="left" valign="middle"><input type="image" src="images/submit.jpg" border="0" name="submit" id="submit" value="submit" /></td> 
</tr>
<tr>
...
<?php
$select_user = "SELECT * FROM `logo_upload`";
...
?>
        ...
        <div>
       		  <table width="800" border="0" cellpadding="0" cellspacing="0" style="border-top:solid #CCC 1px; border-bottom-style:inset; box-shadow: 0 -2px 2px -2px #999; background:#F5F5F5;">
  <tr>
    <td width="496" style="padding:6px 0 6px 15px;"><?php echo "<img src='logo/$logo' border='0' width='100' height='65' />"; ?></td>
    <td width="180" align="center" class="baneer_link"><a href=""><?php echo $category; ?></a></td>
    <td width="124" align="center"><a href="logoupload_delete.php?id=<?php echo $id;?>&logo=<?php echo $logo;?>"><img src="images/delete.png" height="24" width="75" border="0" /></a></td>
  </tr>
</table>
            </div>
                    <?php } ?> 
