...
$query= "INSERT INTO `page_news_flash` (`caption`,`path`) 
                       VALUES('$caption','$path')";

			$query_exi= mysql_query($query) or die(mysql_error());
		
echo "<script type='text/javascript'> window.location= 'home_news_flash.php?success'; </script>";
...
<tr> 
  <td height="35" align="left" class="form_txtr">Caption</td>  <td width="20" height="35" align="center" valign="middle"> : </td>
...
<?php
$select_user = "SELECT * FROM `page_news_flash` order by id DESC";
...
?>
  ...
  <tr>
    ...
    <td width="123" align="center"><a href="home_news_flash_delete.php?id=<?php echo $id;?>"><img src="images/delete.png" height="24" width="75" border="0" /></a></td>
  </tr>
</table>
            </div>
                    <?php } ?> 
