...
$select_ad1 = "SELECT * FROM `static_ads` where `id`='7'";
...
$query_update= "UPDATE `static_ads` SET 
            ...
            echo "<script type='text/javascript'> window.location= 'sidefeature_img.php?success'; </script>";	
...
{
$select_ad1 = "SELECT * FROM `static_ads` where `id`='8'";
$exe_ad1 = mysql_query($select_ad1) or die (mysql_error());
...
<tr> <td height="40" colspan="6"  align="center" class="edit">Featured Image</td> </tr>
...
<tr>
<td width="126" height="35" align="left" valign="middle" class="form_txtr">Quote O Katha</td>
<td width="152" height="35" align="left" valign="middle"><input type="text" id="url1" name="url1" value="#" /></td>
<td width="101" align="left" valign="middle" class="form_txtr">Image:</td>
<td width="261" align="left" valign="middle"><input onchange="readURL(this);" type="file" name="static_ad1" id="static_ad1" style="width:250px; height:20px;" /></td>
    <td width="100" align="left" valign="middle"><input type="image" src="images/submit.jpg" border="0" name="submit1" id="submit1" value="submit" /></td>
</tr>
</form>
...
<tr>
<td height="35" align="left" valign="middle" class="form_txtr">Featured Image</td>
<td width="152" height="35" align="left" valign="middle"><input type="text" id="url2" name="url2" value="#" /></td>
<td width="101" align="left" valign="middle" class="form_txtr">Image:</td>
<td width="261" align="left" valign="middle"><input onchange="readURL(this);" type="file" name="static_ad2" id="static_ad2" style="width:250px; height:20px;" /></td>
    <td width="100" align="left" valign="middle"><input type="image" src="images/submit.jpg" border="0" name="submit2" id="submit2" value="submit" /></td>
</tr>
</form>
<?php /*?>
...
<table width="900" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" bgcolor="#999999" class="form_txtr">Quote O Katha (300px X 450px)</td>
    <td>&nbsp;</td>
    <td align="center" bgcolor="#999999" class="form_txtr">Featured Image (300px X 200px)</td>
  </tr>
  <tr>
    <td width="440">
	<?php
...
?>
    ...
    <td width="460">
	<?php
$select_ad2 = "SELECT * FROM `static_ads` where `id`='8'";
